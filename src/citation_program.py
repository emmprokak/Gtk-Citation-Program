...
class CitationProgram(Gtk.Window):
	...
	def __init__(self):
		...
		self.set_title("~Gtk Citation Program v1.0~")
	...
	def cite_paper(self,widget):
		self.check_citation_type()
		window_paper = CitePaper(self.style)
		
	def cite_book(self,widget):
		self.check_citation_type()		
		window_book = CiteBook(self.style)
		
	def cite_chapter(self,widget):
		self.check_citation_type()
		window_chapter = CiteChapter(self.style)
