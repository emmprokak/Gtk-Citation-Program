...
class BookCitationGUI(Gtk.Window):
	
	def __init__(self,style):
		
		self.init_glade_file()
		self.style = style
		self.publish_type = "book"
	...
	def init_glade_file(self):
		glade_file = "book.glade"
		self.builder = Gtk.Builder()
		self.builder.add_from_file(glade_file)
		
	def init_window_and_buttons(self):
		self.window = self.builder.get_object("book_window")
	...
	def init_entries_and_labels(self):
		...
		self.entry_place = self.builder.get_object("entry_place")
		self.entry_publisher = self.builder.get_object("entry_publisher")
